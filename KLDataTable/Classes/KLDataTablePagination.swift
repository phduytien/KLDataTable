...
open class KLDataTablePagination : KLView {
    
    fileprivate let disposeBag = DisposeBag()
    fileprivate var theme: DataTableTheme!
    ...
    public var selectedPageSize = BehaviorRelay<UInt>(value: 10)
    public var selectedPage = BehaviorRelay<UInt>(value: 1)
    public var total = BehaviorRelay<Int>(value: 0)
